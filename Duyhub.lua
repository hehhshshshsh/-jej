...
local Tabs = {
    ...
    Teleport = Window:AddTab({ Title = "Đảo", Icon = "" }),
    Fruit = Window:AddTab({ Title = "Trái", Icon = "" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "" }),
    Race = Window:AddTab({ Title = "Tộc V4", Icon = "" }),
    Shop = Window:AddTab({ Title = "Cửa hành", Icon = "" }),
	Misc = Window:AddTab({ Title = "Khác", Icon = "" }),
    Hop = Window:AddTab({ Title = "Đổi sv", Icon = "" }),
...
local boss = Tabs.Main:AddSection("Farm Boss")
    ...
    spawn(function()
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Nhặt lua Linh Hồn",Description = "", Default = false })
...
if Third_Sea then
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = "Đánh Terrorshark",Description = "", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = " Đánh Piranha",Description = "", Default = false })
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = "Đánh cá Mập",Description = "", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = " Đánh Fish Crew",Description = "", Default = false })
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Gom Quái[OP]",Description = "", Default = true })
